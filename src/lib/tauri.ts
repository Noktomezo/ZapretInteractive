...
export const openStrategiesDirectory = (): Promise<void> => invoke('open_strategies_directory')
export const getFiltersPath = (): Promise<string> => invoke('get_filters_path')
// fallow-ignore-next-line unused-export
export const getStrategiesPath = (): Promise<string> => invoke('get_strategies_path')
