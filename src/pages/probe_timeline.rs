    ...
    div()
        ...
        .child(
            div()
                ...
                .child(
                    div().relative().h_full().flex().justify_center().children(
                        names[visible.clone()]
                            .iter()
                            .enumerate()
                            .map(|(visible_index, name)| {
                                ...
                                div()
                                    ...
                                    .child(if index.is_multiple_of(2) {
                                        timeline_label(name, active)
                                    } else {
                                        div().h(px(20.))
                                    })
                                    .child(
                                        div().h(px(22.)).flex().items_center().child(
                                            div()
                                                .size(if active { px(10.) } else { px(6.) })
                                                .rounded_full()
                                                .border_1()
                                                ...
                                                .bg(if active { accent() } else { card_color() }),
                                        ),
                                    )
                                    .child(if index.is_multiple_of(2) {
                                        div().h(px(20.))
...
fn timeline_label(name: &str, active: bool) -> Div {
    div()
        .h(px(20.))
        .max_w(px(112.))
        .truncate()
